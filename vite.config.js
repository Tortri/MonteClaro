...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-inter text-gray-800 antialiased">
        ...
        <nav className="container mx-auto flex items-center justify-between p-4 md:px-6">
          ...
          <div className="flex items-center">
            ...
            <img
              ...
              onError={(e) => { e.target.onerror = null; e.target.src="https://placehold.co/40x40/F0F0F0/000000?text=MC" }} // Fallback with light grey color
            />
      ...
      <main>
        {/* Hero Section */}
        <section id="inicio" className="relative h-screen flex items-center justify-center text-center bg-cover bg-center" style={{ backgroundImage: "url('mezcal_background.png')" }}>
        ...
        <section id="nosotros" className="py-16 bg-gradient-to-br from-gray-100 to-gray-200">
          <div className="container mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <img src="https://placehold.co/600x400/F0F0F0/000000?text=Proceso+Artesanal" alt="Proceso Artesanal del Mezcal" className="rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300" />
            </div>
          </div>
        </section>

        {/* New Section: Proceso (Production Details Placeholder) */}
        <section id="proceso" className="py-16 bg-white">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-4xl font-bold text-green-700 mb-12">Elaboración de Mezcal Monte Claro</h2>
            <p className="text-lg text-gray-700">
              Detalles sobre el proceso de producción de nuestro mezcal se añadirán aquí.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              <div className="bg-gray-50 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src="https://placehold.co/200x300/F0F0F0/000000?text=Mezcal+Espadín" alt="Mezcal Espadín Monte Claro" className="rounded-lg mb-6 max-h-72 object-contain" />
              ...
              <div className="bg-gray-50 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src="https://placehold.co/200x300/F0F0F0/000000?text=Mezcal+Reposado" alt="Mezcal Reposado Monte Claro" className="rounded-lg mb-6 max-h-72 object-contain" />
              ...
              <div className="bg-gray-50 rounded-xl shadow-lg p-6 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src="https://placehold.co/200x300/F0F0F0/000000?text=Mezcal+Tobalá" alt="Mezcal Tobalá Monte Claro" className="rounded-lg mb-6 max-h-72 object-contain" />
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="bg-white text-gray-800 rounded-xl shadow-lg p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src="bodas.png" alt="Bodas" className="rounded-full mb-6" />
              ...
              <div className="bg-white text-gray-800 rounded-xl shadow-lg p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src="restaurantes.png" alt="Restaurantes" className="rounded-full mb-6" />
              ...
              <div className="bg-white text-gray-800 rounded-xl shadow-lg p-8 flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
                <img src="eventos.png" alt="Eventos Especiales" className="rounded-full mb-6" />
